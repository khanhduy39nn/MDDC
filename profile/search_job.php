...
<div style="float:left;">
	...
	<a href='../cv/' class='menu_bar'>UPLOAD CV</a> 
	<?php } ?>
</div>
<br><br>
...
<form method="get" action="/jobs/">	
	...
	<tbody>	
		...
		<tr class="cv">
			...
			<td width="80%"><input type="text" id="skill" name="skill" value="<?php if(isset($_GET['s'])){ echo $_GET['s']; } ?>" placeholder="" style="width:400px;color: #000 !important;"></td>
		</tr>		
		<tr >
			<td width="20%" style="text-align:right !important; font-size:1.3em;">Business Type: </td>
			<td width="80%">    	
			<select name="type" style="color: #000 !important;width:195px" value="<?php if(isset($_GET['type'])){ echo $_GET['type']; } ?>">
...
or <input type="text" name="s_location" value="<?php if(isset($_GET['s_location'])){ echo $_GET['s_location']; } ?>" placeholder="other locations" style="width:185px;color: #000 !important;">
		...
		<script>
			...
			$('#skill').inputosaurus({
				...
				change : function(ev){
					/*$('#skill_hide').val(ev.target.value);*/
				}
			});
		</script>
<script>
