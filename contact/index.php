...
<?php 
$sql = "select services from settings";
$result = mysql_query($sql) or die(mysql_error());
...
<h1>Contact Us</h1>
<br>
<div><?php echo $services['services']; ?></div>
<!-- COntact -->
<div class="form_services" style="width:45%; margin-left:auto; margin-right:auto;float:left;"><?php echo $contact['contact']; ?></div>
<div class="form_services" style="width:45%; margin-left:auto; margin-right:auto;float:right;">
		...
		<form method="post" action="send_contact.php">
			<table id="form_contact" border="0" cellspacing="5" cellpadding="5" style="float:left; margin-left: auto;margin-right: auto; width:700px;">		
				<tr>
					...
					<td width="80%"><input name="FirstName" style="width:380px;color:#000 !important;" value="" type="text" id="firstname"></td>
				</tr>
				<tr>
					<td width="20%" style="text-align:right !important; font-size:1.3em;">Last Name: </td>
					<td width="80%"><input name="LastName" style="width:380px;color:#000 !important;" value="" type="text" id="lastname"></td>
				</tr>				
				<tr>
					<td width="20%" style="text-align:right !important; font-size:1.3em;">E-mail: </td>
					<td><input name="Email" style="width:380px;color:#000 !important;" type="text" id="email" value="" size="30"></td>
				</tr>
				<tr>
					<td width="20%" style="text-align:right !important;font-size:1.3em;">Message: </td>
					<td><textarea name="message" style="width:380px;color:#000 !important;" ></textarea></td>
				</tr>
				
				<tr>
					<td width="20%" style="text-align:right !important;font-size:1.3em;">Captcha</td>
					<td style="vertical-align:top;">
						<!--<div class="g-recaptcha" data-sitekey="6Lfwag4TAAAAAF4MrxpIfMolQQzG_xyhGSOpNQZG"></div>-->
