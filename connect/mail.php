<?php
  ...
  <body style="color:#D8DB43;font-family:Geneva, Arial, Helvetica, sans-serif;width:100%;padding-bottom:20px;background-color:#000;">
    <table style="background:#000; color:#D8DB43;">
      <tr>
        <td><a style="color:#D8DB43; text-decoration:none;" target="_blank" href="http://milliondollardesiclub.com/register/registerbyinvite.php/?regcode='.$regcode.'"><img alt="Million Dollar Desi Club" src="http://milliondollardesiclub.com/logo.jpg"></a></td>
      </tr>
      <tr>
        <td>
