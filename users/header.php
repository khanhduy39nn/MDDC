...
?>
<div style="width:100%;">
<a style="display:block; float:left;" href="<?php echo BASE_HTTP_PATH."index1.php"; ?>"><img alt="Million Dollar Desi Club" src="<?php echo SITE_LOGO_URL; ?>" style="max-width:250px;margin:30px;" ></a>
<div style="  display: block;width: auto;padding-top: 67px;font-weight: bold;padding-left: 436px;font-family: 'arial black';font-size: 12px;">
<span style="text-transform:uppercase;font-weight: bold;font-family: 'Arial Black', Helvetica;font-size:12px;">Insight through inspiration & innovation...</span><br>
...
<div class="menu_bar">
<a href="../index1.php" class="menu_bar">HOME</a> 
| <a href="index.php" class="menu_bar"><?php echo strtoupper($label['advertiser_header_nav1']); ?></a> 
| <a href="<?php echo $order_page; ?>" class="menu_bar"><?php echo strtoupper($label['advertiser_header_nav2']);?></a>  
| <a href="publish.php"  class="menu_bar"><?php echo strtoupper($label['advertiser_header_nav3']);?></a> 
| <a href="orders.php"  class="menu_bar"><?php echo strtoupper($label['advertiser_header_nav4']);?></a>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;  <?php
if ($_SESSION['MDS_ID']!='') { ?>
	<a href='post_job.php'  class="menu_bar" >POST JOBS</a>
	|<a href='logout.php'  class="menu_bar" ><?php echo strtoupper($label['advertiser_header_nav5']); ?></a>
<?php } ?>
</div>
