<style>
		td.list_header_cell a, td.list_data_cell a {
...
<table border=0  style="background-color:#d9d9d9 !important;" cellspacing="1" cellpadding="5">
<tr bgcolor="#ffffff">
...
?>
	...
	<img style="border-right:#C8BE5B !important; border-bottom:#C8BE5B !important;" src="show_map.php?BID=<?php echo $BID;?>&time=<?php echo (time()); ?>" width="<?php echo (G_WIDTH*BLK_WIDTH); ?>" height="<?php echo (G_HEIGHT*BLK_HEIGHT); ?>" border="0" usemap="#main" />
	</center>
	<div style='background-color: #000; border-color:#C8BE5B; border-style:solid;padding:10px'>
