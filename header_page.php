...
<meta name="description" content="<?php 
	switch($page_title){
		case "index_job":
			echo "MDDC will bring you the latest & best employment opportunities on behalf of our corporate partners and the various companies and sectors they are working on behalf of";			
		break;
		case "detail_job":
			echo substr(strip_tags($detail_jobs['description']),0,300);
		break;
		case "detail_candidate":
			echo substr(strip_tags($detail_cadidate['description']),0,300);
		break;
		default:
			echo SITE_NAME;
		break;
...
?>" />
<meta name="keywords" content="<?php echo SITE_NAME; ?><?php 
	switch($page_title){
		case "index_job":
			echo ",Agriculture & Forestry/Wildlife,Business & Information,Construction/Utilities/Contracting,Education,Finance & Insurance,Food & Hospitality,Gaming,Motor Vehicle ,Natural Resources/Environmental ,Real Estate & Housing";			
		break;
		case "detail_job":
			echo ", ".$detail_jobs['job'];
		break;
		case "detail_candidate":
			echo ", ".$detail_candidate['business_type'];
		break;
	}
?>" />
<style type="text/css">
	...
	.content-million *:not(.main_button) {
		color: #D8E378 !important;
	}
	.content-million hr {
		border-color: #D8E378 !important;
	}
	.content-million a {
...
<title><?php 
	switch($page_title){
		...
		break;
		case "detail_job":
			echo $detail_jobs['title']." - ".$detail_jobs['job']." - ";
		break;
		case "detail_candidate":
			echo $detail_candidate['title']." - ".$detail_candidate['business_type']." - ";
		break;		
	}
...
<script>(function(d, s, id) {
  ...
  js.src = "//connect.facebook.net/en_US/sdk.js#xfbml=1&version=v2.5&appId=1420355971604779";
...
<div id="logo">
	<a style="display:block; float:left;" href="<?php echo BASE_HTTP_PATH."index1.php"; ?>">
		<img alt="Million Dollar Desi Club" src="<?php echo SITE_LOGO_URL; ?>" >
	</a>
</div>
