...
<body style="margin: 0px; font-family:Verdana, Geneva, Arial, Helvetica, sans-serif; font-size: 24px; color:#D8DB43; text-decoration: none; text-autospace: 1; text-transform: uppercase; padding-left: 0; background: #0c0708;">
<?php 
...
<div id="dialog" style="display:none;">
  <p>
	...
	<div style="width:600px; margin-left:auto; margin-right:auto; display:block;">
		<p style="display:block; width: 34%;float: left; margin-left: 70px;"><a style="outline: none;" href="login.php"><img src="upload_files/images/login.png" /></a></p>
		<p style="display:block; width: 7%;float: left;     padding-top: 20px;">OR</p>
		<p style="display:block; width: 34%;float: left;"><a style="outline: none;" href="register/register.php"><img src="upload_files/images/register.png" /></a></p>
...
<table border="0" width="100%" cellpadding=0 cellspacing=0 >
	<tr >
		<td class="heading_bar" width="32.4%">
			<IMG border="0" SRC="logo.gif" WIDTH="276" HEIGHT="150" BORDER="0" ALT=""></td>
		<td class="heading_bar" nowrap>
		<div style="margin-top:45px;font-family:'arial black';">
		THE HOME OF THE VERY BEST DESI BUSINESSES. 1 PIXEL - &pound;1<br>
		...
		<td align='right' class="heading_bar">
	...
	<tr>
		<td colspan='3' class="menu_bar">
			<a href='index.html' class='menu_bar'>Home</a> 
			| <a href='about/' class='menu_bar'>About Us</a> 
			| <a href='users/' class='menu_bar'>Pixels Purchase</a>
			| <a href='jobs/' class='menu_bar'>Jobs</a> 	
			| <a href='services/' class='menu_bar'>Services</a> 
			| <a href='featured/' class='menu_bar'>MDDCTV</a> 
			| <a href='../scholarship/' class='menu_bar'>SCHOLARSHIP</a>	
			<?php if(isset($_SESSION['login_register']) && $_SESSION['login_register'] == 'yes'){ ?> 
			| <a href='logout.php' class='menu_bar'>LOG OUT</a> 
			<?php } ?>
		</td>
	</tr>
</table>
...
<div style="padding:0px 6px;">
	...
	<!-- New grid 09072015 -->
	<?php $sql = mysql_query("SELECT DISTINCT blocks.order_id, blocks.user_id,blocks.url,blocks.block_id,blocks.alt_text, blocks.ad_id, COUNT(*) AS Total, ads.3, ads.thumb
                     FROM blocks, ads
                    WHERE (published = 'Y')
					  AND (status = 'sold' ) 
		...
		while($row = mysql_fetch_assoc($sql)){
			$row['sort'] = rand(0,5000 + 4800*round(rand(0,1)));
			$arr_ads[] = $row;
		}
		/*echo "<pre>";
		print_r($arr_ads);
	...
	<div id="main_grid">	
		<?php for($i = 0; $i < 10000 ; $i++){ ?>
			<?php foreach($arr_ads as $ad ){ ?>
				<?php if($i == $ad['sort']){ ?>
				<?php $content_sticky .= '<div id="sticky'.$ad['sort'].'">'.$ad['alt_text'].'<br><img src="http://milliondollardesiclub.com/upload_files/images/'.$ad['3'].'" /></div>'; ?>			
				<span class="grid">
					<a target="_blank" href="<?php echo $ad['url']; ?>">
						<img src="http://milliondollardesiclub.com/upload_files/images/<?php echo $ad['thumb']; ?>" data-tooltip="sticky<?php echo $ad['sort']; ?>" class="on_index" />
					</a>
				</span><?php }else{ ?>
