...
if(!empty($_POST)){
	...
	if(!empty($_FILES['attach'])){                   
			...
			$url_attach = 'http://milliondollardesiclub.com/upload_files/images/'.$name;		
			try {
				move_uploaded_file($_FILES['attach']['tmp_name'], 'http://milliondollardesiclub.com/upload_files/images/'.$name);			
				echo $url_attach."<br>";
			} catch (Exception $e) {
