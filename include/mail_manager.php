...
//function send_apply_job($mail_row)
function send_apply_job($mail_row) {	
	$to_address = $mail_row['to_address'];	
	$subject = html_ent_to_utf8($mail_row['subject']);
	$message = html_ent_to_utf8($mail_row['message']);	
    ...
    $email_message->smtp_host='milliondollardesiclub.com';
    $email_message->smtp_direct_delivery=0;    
    $email_message->smtp_user='no_reply@milliondollardesiclub.com';    
    $email_message->smtp_password='12345@54321';  
	$email_message->smtp_ssl=0;
	...
	$reply_address= 'admin@milliondollardesiclub.com';	
	$reply_name = "Million Dollar Desi Club";
	$error_delivery_name="Million Dollar Desi Clu";
	$error_delivery_address='admin@milliondollardesiclub.com';
	
		
	$email_message->default_charset='UTF-8';
	$email_message->SetEncodedEmailHeader("To",'huongthien1993@gmail.com','Thien Nguyen');
	$email_message->SetEncodedEmailHeader("From",'admin@milliondollardesiclub.com','Million Dollar Desi Club');
	$email_message->SetEncodedEmailHeader("Reply-To",$reply_address,$reply_name);
	...
	//attachment
	if ($mail_row['attachments']!='') {
		$attachment=array(
			 "FileName"=>$mail_row['attachments'],
			 "Content-Type"=>"automatic/name",
			 "Disposition"=>"attachment"
		  );
