        ...
        <tr>
            ...
            <td  bgcolor="#e6f2ea">
				<?php 
					if($row['status'] == 0){
				?>
				<font face="Verdana" size="1"><a href="jobs_business.php?a=<?php echo $row['id']; ?>">Approved</a></font>
				<?php }
					if($row['status'] == 1){
				?>
				<font face="Verdana" size="1"><a href="jobs_business.php?b=<?php echo $row['id']; ?>">Unset Approved</a></font>
				
				<?php } ?>
				/
				<font face="Verdana" size="1"><a onclick="return confirm('Do you want delete this job #<?php echo $row['id']; ?>');" href="jobs_business.php?del=<?php echo $row['id']; ?>">Delete</a></font>
			</td>
        </tr>
        <?php
            }
