...
<tr>
	...
	<td><b><font face="Arial" size="2">Country</font></b></td>
...
<td><input type="checkbox" name="users[]" value="<?php echo $row[ID]; ?>"></td>
	...
	<td><font face="Arial" size="1"><?php echo $row[buss_type];?></font></td>
	<td><font face="Arial" size="1"><?php echo $row[country];?></font></td>
	<td><font face="Arial" size="1"><?php echo $row[city];?></font></td>
